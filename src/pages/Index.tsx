...
const Index = () => {
  return (
    <div className="min-h-screen bg-background text-foreground">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 animate-fade-in">
              <div className="flex items-center gap-2 text-primary">
                ...
                <span className="text-sm font-medium">Assistência Técnica 24/7</span>
              </div>
              <h2 className="text-5xl md:text-6xl font-bold leading-tight">
                Seu equipamento de volta ao <span className="text-primary">jogo</span>
              </h2>
              <p className="text-muted-foreground text-lg">
                Reparo especializado em PC, Notebook e Consoles. Agilidade, qualidade e a garantia que você confia.
              </p>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Card 
                key={index} 
                className="p-6 bg-card border-border hover:bg-card/80 hover:border-primary/50 transition-all hover:shadow-glow group"
              >
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              <Card key={index} className="p-6 bg-card border-border relative overflow-hidden group hover:border-primary/50 transition-all">
      ...
      <a
        href="https://wa.me/5599999997765"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-8 right-8 w-14 h-14 bg-primary rounded-full flex items-center justify-center shadow-glow-lg hover:scale-110 transition-transform z-50"
        aria-label="WhatsApp"
      >
